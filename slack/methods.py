...
class Methods(Enum):
    ...
    APPS_PERMISSIONS_REQUEST = (
        ROOT_URL + "apps.permissions.request",
        None,
        None,
        False,
    )
    ...
    CONVERSATIONS_HISTORY = (
        ROOT_URL + "conversations.history",
        "cursor",
        "messages",
        False,
    )
    ...
    CONVERSATIONS_MEMBERS = (
        ROOT_URL + "conversations.members",
        "cursor",
        "members",
        False,
    )
    ...
    CONVERSATIONS_REPLIES = (
        ROOT_URL + "conversations.replies",
        "cursor",
        "messages",
        False,
    )
    CONVERSATIONS_SET_PURPOSE = (
        ROOT_URL + "conversations.setPurpose",
        None,
        None,
        True,
    )
